...
const AddActivityPopup: React.FC<AddActivityPopupProps> = ({ leadId, customerId, open, onClose, onSuccess }) => {
  ...
  useEffect(() => {
    if (open) {
      setActivityNew({type: 'CALL', nextFollowUpAt: new Date().toISOString()} as Activity);
    }
  }, [open]);
      ...
      <div className="modal">
        ...
        <div className="field">
          ...
          <input
            ...
            onChange={e => setActivityNew({ ...activityNew, content: e.target.value } as Activity)}
            placeholder="test"
            className="input"
          />
        </div>
        ...
        <div className="field">
          ...
          <input
            ...
            onChange={e => setActivityNew({ ...activityNew, outcome: e.target.value } as Activity)}
